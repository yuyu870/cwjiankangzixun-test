...
var centerMenu = [
    ...
    ,{
        name: '顾问预约',
        url: '../guwenYuyue/list.html'
    }
    ,{
        name: '健康知识收藏',
        url: '../jiankangzhishiCollection/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/cwjiankangzixun/admin/dist/index.html#/login";
