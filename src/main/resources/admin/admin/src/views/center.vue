<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='guwen'"  label='顾问姓名' prop="guwenName">
               <el-input v-model="ruleForm.guwenName"  placeholder='顾问姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='guwen'"  label='顾问手机号' prop="guwenPhone">
               <el-input v-model="ruleForm.guwenPhone"  placeholder='顾问手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='guwen'"  label='顾问身份证号' prop="guwenIdNumber">
               <el-input v-model="ruleForm.guwenIdNumber"  placeholder='顾问身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='guwen'" label='顾问头像' prop="guwenPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='guwen'"  label='擅长' prop="guwenShanchang">
               <el-input v-model="ruleForm.guwenShanchang"  placeholder='擅长' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='guwen'"  label='顾问邮箱' prop="guwenEmail">
               <el-input v-model="ruleForm.guwenEmail"  placeholder='顾问邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='guwen'"  label="顾问介绍" prop="guwenContent">
                 <editor
                         style="min-width: 200px; max-width: 600px;"
                         v-model="ruleForm.guwenContent"
                         class="editor"
                         action="file/upload">
                 </editor>
             </el-form-item>
...
|| flag=='guwen')"  label="性别" prop="sexTypes">
...
// 注册表 顾问 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.guwenName)&& 'guwen'==this.flag){
                             this.$message.error('顾问姓名不能为空');
                             return
                         }

                             if( 'guwen' ==this.flag && this.ruleForm.guwenPhone&&(!isMobile(this.ruleForm.guwenPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.guwenIdNumber)&& 'guwen'==this.flag){
                             this.$message.error('顾问身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.guwenPhoto)&& 'guwen'==this.flag){
                             this.$message.error('顾问头像不能为空');
                             return
                         }

                         if((!this.ruleForm.guwenShanchang)&& 'guwen'==this.flag){
                             this.$message.error('擅长不能为空');
                             return
                         }

                             if( 'guwen' ==this.flag && this.ruleForm.guwenEmail&&(!isEmail(this.ruleForm.guwenEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
                         if((!this.ruleForm.guwenContent)&& 'guwen'==this.flag){
