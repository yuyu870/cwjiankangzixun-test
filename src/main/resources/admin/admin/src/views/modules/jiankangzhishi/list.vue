        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/cwjiankangzixun/upload/jiankangzhishiMuBan.xls"
                        >批量导入健康知识数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jiankangzhishi','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="jiankangzhishiUuidNumber"
                                   header-align="center"
                                   label="健康知识编号">
                        <template slot-scope="scope">
                            {{scope.row.jiankangzhishiUuidNumber}}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="jiankangzhishiFile"
                                     header-align="center"
                                     width="200"
                                     label="附件">
                        <template slot-scope="scope">
                            <div v-if="scope.row.jiankangzhishiFile">
                                <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+scope.row.jiankangzhishiFile">下载</a>
                            </div>
                            <div v-else>无文件</div>
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="jiankangzhishiVideo"
                                     header-align="center"
                                     width="200"
                                     label="视频">
                        <template slot-scope="scope">
                            <div v-if="scope.row.jiankangzhishiVideo">
                                <video :src="$base.url+scope.row.jiankangzhishiVideo" width="100" height="100" controls="controls">
                                </video>
                            </div>
                            <div v-else>无视频</div>
                        </template>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="jiankangzhishiClicknum"
                                      header-align="center"
                                      label="健康知识热度">
                        <template slot-scope="scope">
                            {{scope.row.jiankangzhishiClicknum}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="shangxiaTypes"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('jiankangzhishi','修改')" type="primary" icon="el-icon-tickets" size="mini" @click="shangxia(scope.row.id,scope.row.shangxiaTypes)">{{scope.row.shangxiaTypes == 1?'下架':'上架'}}</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                jiankangzhishiUuidNumber : null,
                jiankangzhishiPhoto : null,
                jiankangzhishiFile : null,
                jiankangzhishiVideo : null,
                zanNumber : null,
                caiNumber : null,
                jiankangzhishiTypes : null,
                jiankangzhishiClicknum : null,
                jiankangzhishiContent : null,
                shangxiaTypes : null,
                jiankangzhishiDelete : null,
                insertTime : null,
                createTime : null,
            },
            dataList: [],
