    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="guwenYuyueUuidNumber">
                       <el-input v-model="ruleForm.guwenYuyueUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.guwenYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="guwenYuyueUuidNumber">
                           <el-input v-model="ruleForm.guwenYuyueUuidNumber"
            ...
            <input id="guwenId" name="guwenId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约缘由" prop="guwenYuyueText">
                        <el-input type="textarea"  :readonly="ro.guwenYuyueText" v-model="ruleForm.guwenYuyueText" placeholder="预约缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.guwenYuyueText" label="预约缘由" prop="guwenYuyueText">
                            <span v-html="ruleForm.guwenYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.guwenYuyueTime"  class="input" label="预约日期" prop="guwenYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.guwenYuyueTime"
                                type="date"
                                placeholder="预约日期"
                                :disabled="ro.guwenYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.guwenYuyueTime" label="预约日期" prop="guwenYuyueTime">
                            <span v-html="ruleForm.guwenYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.guwenYuyueYesnoTypes" label="申请状态" prop="guwenYuyueYesnoTypes">
                        <el-input v-model="ruleForm.guwenYuyueYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.guwenYuyueYesnoText" label="审核回复" prop="guwenYuyueYesnoText">
                        <span v-html="ruleForm.guwenYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.guwenYuyueShenheTime" label="审核时间" prop="guwenYuyueShenheTime">
                        <span v-html="ruleForm.guwenYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    guwenYuyueUuidNumber: false,
                    yonghuId: false,
                    guwenId: false,
                    insertTime: false,
                    guwenYuyueText: false,
                    guwenYuyueTime: false,
                    guwenYuyueYesnoTypes: false,
                    guwenYuyueYesnoText: false,
                    guwenYuyueShenheTime: false,
                },
                ruleForm: {
                    guwenYuyueUuidNumber: new Date().getTime(),
                    yonghuId: '',
                    guwenId: '',
                    insertTime: '',
                    guwenYuyueText: '',
                    guwenYuyueTime: '',
                    guwenYuyueYesnoTypes: '',
                    guwenYuyueYesnoText: '',
                    guwenYuyueShenheTime: '',
                },
                guwenYuyueYesnoTypesOptions : [],
                guwenOptions : [],
                yonghuOptions : [],
                rules: {
                   guwenYuyueUuidNumber: [
                   ...
                   guwenYuyueText: [
                              { required: true, message: '预约缘由不能为空', trigger: 'blur' },
                          ],
                   guwenYuyueTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=guwen_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.guwenYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`guwenYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.guwenYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
