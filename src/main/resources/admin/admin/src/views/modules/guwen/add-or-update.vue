               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="顾问姓名" prop="guwenName">
                       <el-input v-model="ruleForm.guwenName"
                                 placeholder="顾问姓名" clearable  :readonly="ro.guwenName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="顾问手机号" prop="guwenPhone">
                       <el-input v-model="ruleForm.guwenPhone"
                                 placeholder="顾问手机号" clearable  :readonly="ro.guwenPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="顾问身份证号" prop="guwenIdNumber">
                       <el-input v-model="ruleForm.guwenIdNumber"
                                 placeholder="顾问身份证号" clearable  :readonly="ro.guwenIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="擅长" prop="guwenShanchang">
                       <el-input v-model="ruleForm.guwenShanchang"
                                 placeholder="擅长" clearable  :readonly="ro.guwenShanchang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="顾问邮箱" prop="guwenEmail">
                       <el-input v-model="ruleForm.guwenEmail"
                                 placeholder="顾问邮箱" clearable  :readonly="ro.guwenEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.guwenContent"  label="顾问介绍" prop="guwenContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.guwenContent" label="顾问介绍" prop="guwenContent">
                            <span v-html="ruleForm.guwenContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   guwenPhone: [
                              {  required: true, message: '顾问手机号不能为空', trigger: 'blur' },
                   ...
                   guwenIdNumber: [
                              { required: true, message: '顾问身份证号不能为空', trigger: 'blur' },
                   ...
                   guwenPhoto: [
                              { required: true, message: '顾问头像不能为空', trigger: 'blur' },
                          ],
                   guwenShanchang: [
                   ...
                   guwenEmail: [
                              { required: true, message: '顾问邮箱不能为空', trigger: 'blur' },
                   ...
                   guwenContent: [
                              { required: true, message: '顾问介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.guwenContent = _this.ruleForm.guwenContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.guwenContent = this.ruleForm.guwenContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`guwen/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.guwenCrossAddOrUpdateFlag = false;
                                        this.parent.search();
