...
public class JiankangzhishiLiuyanView extends JiankangzhishiLiuyanEntity implements Serializable {
	...
	public JiankangzhishiLiuyanView() {

	}

	public JiankangzhishiLiuyanView(JiankangzhishiLiuyanEntity jiankangzhishiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jiankangzhishiLiuyanEntity);
	...
	public String toString() {
		return "JiankangzhishiLiuyanView{" +
