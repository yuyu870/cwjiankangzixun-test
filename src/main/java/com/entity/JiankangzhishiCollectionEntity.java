...
public class JiankangzhishiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiankangzhishiCollectionEntity() {

	}

	public JiankangzhishiCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "JiankangzhishiCollection{" +
            ", id=" + id +
